...
public class GunECell extends Item
{
	private int damage;
	...
	public GunECell(int var1, int var2, int var3, int var4, int var5, String var6, String var7)
	{
		super(var1);
		this.damage = var2;
		this.fireTotal = var5;
	...
	public ItemStack onItemRightClick(ItemStack var1, World var2, EntityPlayer var3)
	{
		...
		else if (!var2.isRemote && var3.inventory.hasItem(FalloutMain.ECell.itemID) && var1.getItemDamage() == this.ammo)
		{
			if (this.reloadTime == this.reloadTotal)
			{
				...
				{
					var3.inventory.consumeInventoryItem(FalloutMain.ECell.itemID);
					count += 1;
