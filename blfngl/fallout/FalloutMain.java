...
public class FalloutMain
{
	...
	public static final Item minigun = new ItemGun(593, 3, 240, 4, (int) 0.3, "blfngl.MinigunFire", "Blfngl.MinigunReload", GUN, a5mm).setUnlocalizedName("Minigun").setCreativeTab(TabFalloutHeavy);
	public static final Item cyberdog = new ItemGun(594, 3, 50, 4, (int) 0.5, "blfngl.357Fire", "Blfngl.MinigunReload", GUN, a357).setUnlocalizedName("CyberdogGun").setCreativeTab(TabFalloutHeavy);
	public static final Item FIDO = new ItemGun(595, 4, 50, 4, (int) 0.5, "blfngl.44Fire", "Blfngl.MinigunReload", GUN, a44).setUnlocalizedName("FIDO").setCreativeTab(TabFalloutHeavy);
	...
	public static final Item rifleAutomatic = new ItemGun(627, 8, 20, 3, (int) 0.5, "blfngl.AutomaticRifleFire", "Blfngl.PlasmaRifleReload", GUN, a308).setUnlocalizedName("AutomaticRifle").setCreativeTab(TabFalloutRifle);
	...
	//KEY: ID, damage, clip size, reload time, fire time, fire sound, reload sound
	public static final Item rifleAntiMateriel = new ItemGun(643, 20, 8, (int) 2.5, 4, "blfngl.MaterielFire", "Blfngl.MaterielReload", GUN, a50MG).setUnlocalizedName("AntiMaterielRifle").setCreativeTab(TabFalloutRifle);
	public static final Item rifleAssaultCarbine = new ItemGun(645, 6, 24, 2, (int) 0.5, "blfngl.AssaultFire", "Blfngl.AssaultReload", GUN, a5mm).setUnlocalizedName("AssaultCarbine").setCreativeTab(TabFalloutRifle);
	public static final Item rifleLMG = new ItemGun(646, 6, 90, (int) 2.2, (int) 0.5, "blfngl.LMGFire", "Blfngl.LMGReload", GUN, a556).setUnlocalizedName("LMG").setCreativeTab(TabFalloutRifle);
	public static final Item rifleBozar = new ItemGun(647, 7, 30, (int) 2.2, (int) 0.5, "blfngl.LMGFire", "Blfngl.LMGReload", GUN, a556).setFull3D().setUnlocalizedName("Bozar").setCreativeTab(TabFalloutRifle);
	public static final Item rifleMarksmanCarbine = new ItemGun(648, 7, 20, (int) 2.5, 1, "blfngl.MarksmanFire", "Blfngl.MarksmanReload", GUN, a556).setUnlocalizedName("MarksmanCarbine").setCreativeTab(TabFalloutRifle);
	public static final Item rifleAllAmerican = new ItemGun(649, 8, 24, (int) 2.5, 1, "blfngl.MarksmanFire", "Blfngl.MarksmanReload", GUN, a556).setUnlocalizedName("AllAmerican").setCreativeTab(TabFalloutRifle);
	public static final Item rifleService = new ItemGun(650, 3, 20, 2, (int) 0.7, "blfngl.AutomaticRifleFire", "Blfngl.MarksmanReload", GUN, a556).setUnlocalizedName("ServiceRifle").setCreativeTab(TabFalloutRifle);
	public static final Item rifleSurvival = new ItemGun(651, 7, 10, 2, (int) 0.7, "blfngl.AutomaticRifleFire", "Blfngl.MarksmanReload", GUN, a127).setUnlocalizedName("SurvivalistsRifle").setCreativeTab(TabFalloutRifle);
	...
	public static final Item rifleVarmint = new ItemGun(655, 3, 5, (int) 2.2, 2, "blfngl.VarmintRifleFire", "Blfngl.PlasmaRifleReload", GUN, a556).setUnlocalizedName("VarmintRifle").setCreativeTab(TabFalloutRifle);
	public static final Item rifleRatslayer = new ItemGun(656, 5, 5, (int) 2.2, 2, "blfngl.RatslayerFire", "Blfngl.PlasmaRifleReload", GUN, a556).setUnlocalizedName("Ratslayer").setCreativeTab(TabFalloutRifle);

	public static final Item smg45Auto = new ItemGun(657, 4, 30, (int) 2.2, (int) 0.5, "blfngl.45Fire", "Blfngl.AssaultReload", GUN, a45Auto).setUnlocalizedName("45AutoSub").setCreativeTab(TabFalloutSMG);
	public static final Item smg9mm = new ItemGun(658, 2, 30, (int) 2.7, (int) 0.5, "blfngl.9mmFire", "Blfngl.9mmReload", GUN, a9mm).setUnlocalizedName("9mmSub").setCreativeTab(TabFalloutSMG);
	public static final Item smgVance = new ItemGun(659, 4, 60, (int) 2.2, (int) 0.5, "blfngl.9mmFire", "Blfngl.9mmReload", GUN, a9mm).setUnlocalizedName("VancesSub").setCreativeTab(TabFalloutSMG);
	public static final Item smg10mm = new ItemGun(660, 3, 30, (int) 2.7, (int) 0.5, "blfngl.10MMFire", "Blfngl.10MMReload", GUN, FalloutMain.a10mm).setUnlocalizedName("10mmSub").setCreativeTab(TabFalloutSMG);
	public static final Item smgSleepytyme = new ItemGun(661, 5, 40, (int) 2.7, (int) 0.5, "blfngl.SleepytymeFire", "Blfngl.10MMReload", GUN, FalloutMain.a10mm).setUnlocalizedName("Sleepytyme").setCreativeTab(TabFalloutSMG);
	public static final Item smg127 = new ItemGun(662, 4, 21, 2, (int) 0.5, "blfngl.357Fire", "Blfngl.127SmgReload", GUN, a127).setUnlocalizedName("127Sub").setCreativeTab(TabFalloutSMG);
	public static final Item smgNailGun = new ItemGun(663, 2, 90, (int) 2.7, (int) 0.3, "blfngl.NailgunFire", "Blfngl.9mmReload", GUN, aNail).setUnlocalizedName("NailGun").setCreativeTab(TabFalloutSMG);
	public static final Item smg22 = new ItemGun(664, 1, 180, (int) 2.3, (int) 0.5, "blfngl.Silenced22Fire", "Blfngl.10MMReload", GUN, a22LR).setUnlocalizedName("22Sub").setCreativeTab(TabFalloutSMG);
	public static final Item CZ57 = new ItemGun(666, 5, 120, 4, (int) 0.3, "blfngl.MinigunFire", "Blfngl.MinigunReload", GUN, a5mm).setUnlocalizedName("CZ57").setCreativeTab(TabFalloutHeavy);
	public static final Item pistolWeathered10mm = new ItemGun(667, 5, 12, (int) 1.3, 1, "blfngl.10mmFire", "Blfngl.10MMReload", GUN, FalloutMain.a10mm).setUnlocalizedName("Weathered10mm").setCreativeTab(TabFalloutPistol);

	//KEY: ID, damage, clip size, reload time, fire time, fire sound, reload sound
	public static final Item shotgunCaravan = new ItemGun(668, 5, 2, (int) 1.5, 1, "blfngl.CaravanShotgunFire", "Blfngl.CaravanShotgunReload", GUN, aGauge20).setUnlocalizedName("CaravanShotgun").setCreativeTab(TabFalloutShotgun);
	public static final Item shotgunSturdyCaravan = new ItemGun(669, 7, 2, (int) 1.5, 1, "blfngl.CaravanShotgunFire", "Blfngl.CaravanShotgunReload", GUN, aGauge20).setUnlocalizedName("SturdyCaravanShotgun").setCreativeTab(TabFalloutShotgun);
	public static final Item shotgunLever = new ItemGun(670, 6, 5, (int) 2.5, 2, "blfngl.LeverShotgunFire", "Blfngl.LeverShotgunReload", GUN, aGauge20).setUnlocalizedName("LeverActionShotgun").setCreativeTab(TabFalloutShotgun);
	public static final Item shotgunSawed = new ItemGun(671, 8, 1, (int) 3.1, 2, "blfngl.HuntingShotgunFire", "Blfngl.LeverShotgunReload", GUN, aGauge12).setUnlocalizedName("SawedOffShotgun").setCreativeTab(TabFalloutShotgun);
	public static final Item shotgunBigBoomer = new ItemGun(672, 10, 1, (int) 3.1, 2, "blfngl.HuntingShotgunFire", "Blfngl.LeverShotgunReload", GUN, aGauge12).setUnlocalizedName("BigBoomer").setCreativeTab(TabFalloutShotgun);
	...
	public static final Item rifleChineseAssault = new ItemGun(675, 4, 24, (int) 2.2, (int) 0.5, "blfngl.ChineseAssaultFire", "Blfngl.ChineseAssaultReload", GUN, a556).setUnlocalizedName("ChineseAssaultRifle").setCreativeTab(TabFalloutShotgun);
	public static final Item pistolFlareGun = new ItemGun(676, 1, 1, (int) 2.3, 2, "blfngl.FlareGunFire", "Blfngl.FlareGunReload", GUN, homemadeFuel).setUnlocalizedName("FlareGun").setCreativeTab(TabFalloutShotgun);
