...
public class EntityBullet308 extends Entity implements IProjectile
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityBullet308(World var1)
    {
        super(var1);
    ...
    public EntityBullet308(World var1, double var2, double var4, double var6)
    {
        super(var1);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityBullet308(World var1, EntityLiving var2, EntityLiving var3, float var4, float var5)
    {
        super(var1);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityBullet308(World var1, EntityLiving var2, float var3)
    {
        super(var1);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = var2;
    ...
    public EntityBullet308(World var1, EntityLiving var2, float var3, boolean var4)
    {
        super(var1);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = var2;
