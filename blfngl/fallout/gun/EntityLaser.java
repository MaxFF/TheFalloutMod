...
public class EntityLaser extends Entity implements IProjectile
{
    ...
    public EntityLaser(World var1, double var2, double var4, double var6)
    {
        super(var1);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityLaser(World var1, EntityLiving var2, EntityLiving var3, float var4, float var5)
    {
        super(var1);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityLaser(World var1, EntityLiving var2, float var3)
    {
        super(var1);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = var2;
    ...
    public EntityLaser(World var1, EntityLiving var2, float var3, boolean var4)
    {
        super(var1);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = var2;
