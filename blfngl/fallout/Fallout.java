...
public class Fallout
{
	...
	public static final Item smg10mm = new ItemGun(660, 3, 30, (int) 2.7, (int) 0.5, "blfngl.10MMFire", "Blfngl.10MMReload", Fallout.a10mm).setUnlocalizedName("10mmSub").setCreativeTab(TabFalloutSMG);
	public static final Item smgSleepytyme = new ItemGun(661, 5, 40, (int) 2.7, (int) 0.5, "blfngl.SleepytymeFire", "Blfngl.10MMReload", Fallout.a10mm).setUnlocalizedName("Sleepytyme").setCreativeTab(TabFalloutSMG);
	...
	public static final Item pistolWeathered10mm = new ItemGun(667, 5, 12, (int) 1.3, 1, "blfngl.10mmFire", "Blfngl.10MMReload", Fallout.a10mm).setUnlocalizedName("Weathered10mm").setCreativeTab(TabFalloutPistol);
