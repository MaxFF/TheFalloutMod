...
public class RenderLaserLR extends Render
{
    public void RenderLaserLR(EntityLaserLR par1EntityLaserLR, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        GL11.glRotatef(par1EntityLaserLR.prevRotationYaw + (par1EntityLaserLR.rotationYaw - par1EntityLaserLR.prevRotationYaw) * par9 - 90.0F, 0.0F, 1.0F, 0.0F);
        GL11.glRotatef(par1EntityLaserLR.prevRotationPitch + (par1EntityLaserLR.rotationPitch - par1EntityLaserLR.prevRotationPitch) * par9, 0.0F, 0.0F, 1.0F);
