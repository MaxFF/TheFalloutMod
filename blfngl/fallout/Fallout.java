...
public class Fallout
{
	...
	public static final Item pistolCompliance = new ItemGun(511, 2, 30, 2, 1, "blfngl.LaserPistolFire", "blfngl.ComplianceReload", cellEnergy).setUnlocalizedName("Compliance").setCreativeTab(TabFalloutEnergy);
	...
	public static final Item pistol44 = new ItemGun(513, 5, 6, 3, 3, "blfngl.44Fire", "blfngl.44Reload", a44).setUnlocalizedName("Pistol44").setCreativeTab(TabFalloutPistol);
	public static final Item pistol357 = new ItemGun(514, 4, 6, 1, 2, "blfngl.357Fire", "blfngl.357Reload", a357).setUnlocalizedName("Pistol357").setCreativeTab(TabFalloutPistol);
	public static final Item pistol22 = new ItemGun(515, 2, 12, 2, 1, "blfngl.Silenced22Fire", "blfngl.Silenced22Fire", a22LR).setUnlocalizedName("Silenced22").setCreativeTab(TabFalloutPistol);
	public static final Item rifleSniper = new ItemGun(516, 11, 5, 3, 2, "blfngl.SniperFire", "blfngl.SniperReload", a308).setUnlocalizedName("Sniper308").setCreativeTab(TabFalloutRifle);
	...
	public static final Item crystalArray = new BaseItem(569).setUnlocalizedName("Magnifier").setCreativeTab(TabFalloutPistol);
	...
	public static final Item shotgunCombat = new ItemGun(581, 7, 12, 2, 2, "blfngl.ShotgunFire", "blfngl.ShotgunReload", aGauge12).setUnlocalizedName("CombatShotgun").setCreativeTab(TabFalloutRifle);
	public static final Item shotgunRiot = new ItemGun(582, 7, 12, 2, 1, "blfngl.HuntingShotgunFire", "blfngl.ShotgunReload", aGauge12).setUnlocalizedName("RiotShotgun").setCreativeTab(TabFalloutRifle);
	...
	public static final Item cyberdog = new ItemGun(594, 3, 50, 4, 0.5, "blfngl.357Fire", "Blfngl.MinigunReload", a357).setUnlocalizedName("CyberdogGun").setCreativeTab(TabFalloutHeavy);
	public static final Item FIDO = new ItemGun(595, 4, 50, 4, 0.5, "blfngl.44Fire", "Blfngl.MinigunReload", a44).setUnlocalizedName("FIDO").setCreativeTab(TabFalloutHeavy);
	...
	public static final Item missileLauncher = new ItemGun(597, 14, 1, 4, 2, "blfngl.MissileFire", "Blfngl.MissileReload", aMissile).setUnlocalizedName("MissileLauncher").setCreativeTab(TabFalloutHeavy);
	public static final Item redGlare = new ItemGun(598, 5, 13, 3, 2, "blfngl.RedGlareFire", "Blfngl.RedGlareReload", aRocket).setUnlocalizedName("RedGlare").setCreativeTab(TabFalloutHeavy);
	public static final Item pistol556 = new ItemGun(599, 5, 5, 2, 1, "blfngl.Pistol556Fire", "Blfngl.Pistol556Reload", a556).setUnlocalizedName("556Pistol").setCreativeTab(TabFalloutPistol);
	public static final Item pistolThatGun = new ItemGun(600, 6, 7, 3, 1, "blfngl.Pistol556Fire", "Blfngl.Pistol556Reload", a556).setUnlocalizedName("ThatGun").setCreativeTab(TabFalloutPistol);
	public static final Item pistol127 = new ItemGun(601, 7, 7, 2, 1, "blfngl.44Fire", "Blfngl.9mmReload", a127).setUnlocalizedName("127Pistol").setCreativeTab(TabFalloutPistol);
	...
	//KEY: ID, damage, clip size, reload time, fire time, fire sound, reload sound
	public static final Item shotgunHunting = new ItemGun(613, 13, 7, 3, 4, "blfngl.HuntingShotgunFire", "Blfngl.HuntingShotgunReload", aGauge12).setUnlocalizedName("HuntingShotgun").setCreativeTab(TabFalloutShotgun);
	public static final Item shotgunDinnerBell = new ItemGun(614, 13, 7, 3, 4, "blfngl.HuntingShotgunFire", "Blfngl.HuntingShotgunReload", aGauge12).setUnlocalizedName("DinnerBell").setCreativeTab(TabFalloutShotgun);
	public static final Item pistol9mm = new ItemGun(615, 2, 13, 3, 1, "blfngl.9mmFire", "Blfngl.9mmReload", a9mm).setUnlocalizedName("9mmPistol").setCreativeTab(TabFalloutPistol);
	public static final Item pistolAlienBlaster = new ItemGun(616, 13, 10, 2, 1, "blfngl.AlienBlasterFire", "Blfngl.AlienBlasterReload", aAlien).setUnlocalizedName("AlienBlaster").setCreativeTab(TabFalloutPistol);
	public static final Item rifleHunting = new ItemGun(617, 6, 24, 3, 3, "blfngl.HuntingRifleFire", "Blfngl.HuntingRifleReload", a308).setUnlocalizedName("HuntingRifle").setCreativeTab(TabFalloutRifle);
	public static final Item pistolLucky = new ItemGun(620, 6, 6, 1, 2, "blfngl.357Fire", "Blfngl.357Reload", a357).setUnlocalizedName("Lucky").setCreativeTab(TabFalloutPistol);
	public static final Item pistol45Auto = new ItemGun(621, 5, 7, 2, 1, "blfngl.45Fire", "Blfngl.9mmReload", a45Auto).setUnlocalizedName("45AutoPistol").setCreativeTab(TabFalloutPistol);
	public static final Item pistolLightDarkness = new ItemGun(622, 7, 7, 2, 1, "blfngl.45Fire", "Blfngl.9mmReload", a45Auto).setUnlocalizedName("LightDarkness").setCreativeTab(TabFalloutPistol);
	public static final Item pistolMaria = new ItemGun(623, 5, 13, 2, 2, "blfngl.9mmFire", "Blfngl.9mmReload", a9mm).setUnlocalizedName("Maria").setCreativeTab(TabFalloutPistol);
	public static final Item pistolHuntingRevolver = new ItemGun(624, 8, 5, 3, 3, "blfngl.HuntingFire", "Blfngl.HuntingReload", aGovt).setUnlocalizedName("HuntingRevolver").setCreativeTab(TabFalloutPistol);
	public static final Item pistolRangerSequoia = new ItemGun(625, 10, 5, 3, 3, "blfngl.RangerSequoiaFire", "Blfngl.HuntingReload", aGovt).setUnlocalizedName("RangerSequoia").setCreativeTab(TabFalloutPistol);
	public static final Item pistolPolice = new ItemGun(626, 6, 6, 3, 2, "blfngl.357Fire", "Blfngl.357Reload", a357).setUnlocalizedName("PolicePistol").setCreativeTab(TabFalloutPistol);

	//KEY: ID, damage, clip size, reload time, fire time, fire sound, reload sound, zoom distance
	public static final Item rifleAutomatic = new ItemGun(627, 8, 20, 3, 0.5, "blfngl.AutomaticRifleFire", "Blfngl.PlasmaRifleReload", a308).setUnlocalizedName("AutomaticRifle").setCreativeTab(TabFalloutRifle);
	public static final Item rifleBattle = new ItemGun(628, 6, 8, 2, 3, "blfngl.BattleRifleFire", "Blfngl.BattleRifleReload", a308).setUnlocalizedName("BattleRifle").setCreativeTab(TabFalloutRifle);
	public static final Item rifleThisMachine = new ItemGun(629, 7, 8, 2, 3, "blfngl.BattleRifleFire", "Blfngl.BattleRifleReload", a308).setUnlocalizedName("ThisMachine").setCreativeTab(TabFalloutRifle);
	public static final Item rifleBBGun = new ItemGun(630, 1, 100, 3, 1, "blfngl.BBGunFire", "Blfngl.BBGunReload", aBB).setUnlocalizedName("BBGun").setCreativeTab(TabFalloutRifle);
	public static final Item rifleAbileneKid = new ItemGun(631, 2, 100, 3, 1, "blfngl.BBGunFire", "Blfngl.BBGunReload", aBB).setUnlocalizedName("ABBGun").setCreativeTab(TabFalloutRifle);
	public static final Item rifleBrushGun = new ItemGun(632, 8, 6, 3, 2, "blfngl.BrushGunFire", "Blfngl.RepeaterReload", a308).setUnlocalizedName("BrushGun").setCreativeTab(TabFalloutRifle);
	public static final Item rifleMedicineStick = new ItemGun(633, 9, 6, 3, 2, "blfngl.BrushGunFire", "Blfngl.RepeaterReload", aGovt).setUnlocalizedName("MedicineStick").setCreativeTab(TabFalloutRifle);
	public static final Item rifleCowboyRepeater = new ItemGun(634, 4, 7, 3, 2, "blfngl.CowboyRepeaterFire", "Blfngl.RepeaterReload", a357).setUnlocalizedName("CowboyRepeater").setCreativeTab(TabFalloutRifle);
	public static final Item rifleLongueCarabine = new ItemGun(635, 5, 11, 3, 2, "blfngl.BrushGunFire", "Blfngl.RepeaterReload", a357).setUnlocalizedName("LongueCarabine").setCreativeTab(TabFalloutRifle);
	public static final Item riflePaciencia = new ItemGun(636, 7, 3, 3, 2, "blfngl.HuntingRifleFire", "Blfngl.HuntingRifleReload", a308).setUnlocalizedName("Paciencia").setCreativeTab(TabFalloutRifle);
	...
	//KEY: ID, damage, clip size, reload time, fire time, fire sound, reload sound
	public static final Item rifleAntiMateriel = new ItemGun(643, 20, 8, 2.5, 4, "blfngl.MaterielFire", "Blfngl.MaterielReload", a50MG).setUnlocalizedName("AntiMaterielRifle").setCreativeTab(TabFalloutRifle);
	public static final Item rifleAssaultCarbine = new ItemGun(645, 6, 24, 2, 0.5, "blfngl.AssaultFire", "Blfngl.AssaultReload", a5mm).setUnlocalizedName("AssaultCarbine").setCreativeTab(TabFalloutRifle);
	public static final Item rifleLMG = new ItemGun(646, 6, 90, 2.2, 0.5, "blfngl.LMGFire", "Blfngl.LMGReload", a556).setUnlocalizedName("LMG").setCreativeTab(TabFalloutRifle);
	public static final Item rifleBozar = new ItemGun(647, 7, 30, 2.2, 0.5, "blfngl.LMGFire", "Blfngl.LMGReload", a556).setFull3D().setUnlocalizedName("Bozar").setCreativeTab(TabFalloutRifle);
	public static final Item rifleMarksmanCarbine = new ItemGun(648, 7, 20, 2.5, 1, "blfngl.MarksmanFire", "Blfngl.MarksmanReload", a556).setUnlocalizedName("MarksmanCarbine").setCreativeTab(TabFalloutRifle);
	public static final Item rifleAllAmerican = new ItemGun(649, 8, 24, 2.5, 1, "blfngl.MarksmanFire", "Blfngl.MarksmanReload", a556).setUnlocalizedName("AllAmerican").setCreativeTab(TabFalloutRifle);
	public static final Item rifleService = new ItemGun(650, 3, 20, 2, 0.7, "blfngl.AutomaticRifleFire", "Blfngl.MarksmanReload", a556).setUnlocalizedName("ServiceRifle").setCreativeTab(TabFalloutRifle);
	public static final Item rifleSurvival = new ItemGun(651, 7, 10, 2, 0.7, "blfngl.AutomaticRifleFire", "Blfngl.MarksmanReload", a127).setUnlocalizedName("SurvivalistsRifle").setCreativeTab(TabFalloutRifle);
	public static final Item rifleChristine = new ItemGun(652, 15, 5, 2, 3, "blfngl.ChristineFire", "Blfngl.ChristineReload", a308).setUnlocalizedName("ChristinesRifle").setCreativeTab(TabFalloutRifle);
	public static final Item rifleGobi = new ItemGun(653, 14, 6, 2, 3, "blfngl.SniperFire", "Blfngl.SniperReload", a308).setUnlocalizedName("GobiRifle").setCreativeTab(TabFalloutRifle);
	public static final Item rifleTrailCarbine = new ItemGun(654, 10, 8, 2, 2, "blfngl.TrailCarbineFire", "Blfngl.RepeaterReload", a44).setUnlocalizedName("TrailCarbine").setCreativeTab(TabFalloutRifle);
	public static final Item rifleVarmint = new ItemGun(655, 3, 5, 2.2, 2, "blfngl.VarmintRifleFire", "Blfngl.PlasmaRifleReload", a556).setUnlocalizedName("VarmintRifle").setCreativeTab(TabFalloutRifle);
	public static final Item rifleRatslayer = new ItemGun(656, 5, 5, 2.2, 2, "blfngl.RatslayerFire", "Blfngl.PlasmaRifleReload", a556).setUnlocalizedName("Ratslayer").setCreativeTab(TabFalloutRifle);

	public static final Item smg45Auto = new ItemGun(657, 4, 30, 2.2, 0.5, "blfngl.45Fire", "Blfngl.AssaultReload", a45Auto).setUnlocalizedName("45AutoSub").setCreativeTab(TabFalloutSMG);
	public static final Item smg9mm = new ItemGun(658, 2, 30, 2.7, 0.5, "blfngl.9mmFire", "Blfngl.9mmReload", a9mm).setUnlocalizedName("9mmSub").setCreativeTab(TabFalloutSMG);
	public static final Item smgVance = new ItemGun(659, 4, 60, 2.2, 0.5, "blfngl.9mmFire", "Blfngl.9mmReload", a9mm).setUnlocalizedName("VancesSub").setCreativeTab(TabFalloutSMG);
	public static final Item smg10mm = new ItemGun(660, 3, 30, 2.7, 0.5, "blfngl.10MMFire", "Blfngl.10MMReload", a10mm).setUnlocalizedName("10mmSub").setCreativeTab(TabFalloutSMG);
	public static final Item smgSleepytyme = new ItemGun(661, 5, 40, 2.7, 0.5, "blfngl.SleepytymeFire", "Blfngl.10MMReload", a10mm).setUnlocalizedName("Sleepytyme").setCreativeTab(TabFalloutSMG);
	public static final Item smg127 = new ItemGun(662, 4, 21, 2, 0.5, "blfngl.357Fire", "Blfngl.127SmgReload", a127).setUnlocalizedName("127Sub").setCreativeTab(TabFalloutSMG);
	public static final Item smgNailGun = new ItemGun(663, 2, 90, 2.7, 0.3, "blfngl.NailgunFire", "Blfngl.9mmReload", aNail).setUnlocalizedName("NailGun").setCreativeTab(TabFalloutSMG);
	public static final Item smg22 = new ItemGun(664, 1, 180, 2.3, 0.5, "blfngl.Silenced22Fire", "Blfngl.10MMReload", a22LR).setUnlocalizedName("22Sub").setCreativeTab(TabFalloutSMG);
	public static final Item CZ57 = new ItemGun(666, 5, 120, 4, 0.3, "blfngl.MinigunFire", "Blfngl.MinigunReload", a5mm).setUnlocalizedName("CZ57").setCreativeTab(TabFalloutHeavy);
	public static final Item pistolWeathered10mm = new ItemGun(667, 5, 12, 1.3, 1, "blfngl.10mmFire", "Blfngl.10MMReload", a10mm).setUnlocalizedName("Weathered10mm").setCreativeTab(TabFalloutPistol);

	//KEY: ID, damage, clip size, reload time, fire time, fire sound, reload sound
	public static final Item shotgunCaravan = new ItemGun(668, 5, 2, 1.5, 1, "blfngl.CaravanShotgunFire", "Blfngl.CaravanShotgunReload", aGauge20).setUnlocalizedName("CaravanShotgun").setCreativeTab(TabFalloutShotgun);
	public static final Item shotgunSturdyCaravan = new ItemGun(669, 7, 2, 1.5, 1, "blfngl.CaravanShotgunFire", "Blfngl.CaravanShotgunReload", aGauge20).setUnlocalizedName("SturdyCaravanShotgun").setCreativeTab(TabFalloutShotgun);
	public static final Item shotgunLever = new ItemGun(670, 6, 5, 2.5, 2, "blfngl.LeverShotgunFire", "Blfngl.LeverShotgunReload", aGauge20).setUnlocalizedName("LeverActionShotgun").setCreativeTab(TabFalloutShotgun);
	public static final Item shotgunSawed = new ItemGun(671, 8, 1, 3.1, 2, "blfngl.HuntingShotgunFire", "Blfngl.LeverShotgunReload", aGauge12).setUnlocalizedName("SawedOffShotgun").setCreativeTab(TabFalloutShotgun);
	public static final Item shotgunBigBoomer = new ItemGun(672, 10, 1, 3.1, 2, "blfngl.HuntingShotgunFire", "Blfngl.LeverShotgunReload", aGauge12).setUnlocalizedName("BigBoomer").setCreativeTab(TabFalloutShotgun);
	public static final Item shotgunSingle = new ItemGun(673, 4, 1, 2, 2, "blfngl.LeverShotgunFire", "Blfngl.LeverShotgunReload", aGauge20).setUnlocalizedName("SingleShotgun").setCreativeTab(TabFalloutShotgun);

	public static final Item rifleChineseAssault = new ItemGun(675, 4, 24, 2.2, 0.5, "blfngl.ChineseAssaultFire", "Blfngl.ChineseAssaultReload", a556).setUnlocalizedName("ChineseAssaultRifle").setCreativeTab(TabFalloutShotgun);
	public static final Item pistolFlareGun = new ItemGun(676, 1, 1, 2.3, 2, "blfngl.FlareGunFire", "Blfngl.FlareGunReload", homemadeFuel).setUnlocalizedName("FlareGun").setCreativeTab(TabFalloutShotgun);
	public static final Item pistolPewPew = new ItemGun(677, 6, 2, 3, 1, "blfngl.LaserFire", "Blfngl.LaserPistolReload", cellEnergy).setUnlocalizedName("PewPew").setCreativeTab(TabFalloutShotgun);
	public static final Item pistolPulseGun = new ItemGun(678, 3, 5, 2, 3, "blfngl.PulseFire", "Blfngl.PulseGunReload", cellEnergy).setUnlocalizedName("PulseGun").setCreativeTab(TabFalloutShotgun);
	public static final Item pistolHyperbreederAlpha = new ItemGun(679, 4, 10, 3, 1, "blfngl.RechargerFire", "Blfngl.LeverShotgunReload", aGauge20).setUnlocalizedName("HyperbreederAlpha").setCreativeTab(TabFalloutShotgun);
	public static final Item pistolSonicEmitter = new ItemGun(680, 4, 24, 2, 2, "blfngl.PulseFire", "Blfngl.PulseGunReload", cellEnergy).setUnlocalizedName("SonicEmitter").setCreativeTab(TabFalloutShotgun);
