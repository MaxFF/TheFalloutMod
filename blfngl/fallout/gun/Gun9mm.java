...
public class Gun9mm extends ItemSword
{
	private int damage;
	...
	public Gun9mm(int var1, int var2, int var3, int var4, int var5, String var6, String var7, EnumToolMaterial var8)
	{
		super(var1, var8);
		this.damage = var2;
		this.firemax = var5;
	...
	public ItemStack onItemRightClick(ItemStack var1, World var2, EntityPlayer var3)
	{
		...
		else if (!var2.isRemote && var3.inventory.hasItem(FalloutMain.a9mm.itemID) && var1.getItemDamage() == this.ammo)
		{
			if (this.reloadtick == this.reloadmax)
			{
				...
				{
					var3.inventory.consumeInventoryItem(FalloutMain.a9mm.itemID);
					count += 1;
				}                
