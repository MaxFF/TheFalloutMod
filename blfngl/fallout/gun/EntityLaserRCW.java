...
public class EntityLaserRCW extends Entity implements IProjectile
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityLaserRCW(World var1)
    {
        super(var1);
    ...
    public EntityLaserRCW(World var1, double var2, double var4, double var6)
    {
        super(var1);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityLaserRCW(World var1, EntityLiving var2, EntityLiving var3, float var4, float var5)
    {
        super(var1);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityLaserRCW(World var1, EntityLiving var2, float var3)
    {
        super(var1);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = var2;
    ...
    public EntityLaserRCW(World var1, EntityLiving var2, float var3, boolean var4)
    {
        super(var1);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = var2;
    ...
    {
        this.motionX += this.rand.nextGaussian() * 0.08499999832361937D * (double)var1;
        this.motionY += this.rand.nextGaussian() * 0.08499999832361937D * (double)var1;
        this.motionZ += this.rand.nextGaussian() * 0.08499999832361937D * (double)var1;
    }

    public void setRandom(float var1, float var2)
    {
        this.motionX += this.rand.nextGaussian() * 0.08499999832361937D * (double)var1;
        this.motionY += this.rand.nextGaussian() * 0.08499999832361937D * (double)var2;
        this.motionZ += this.rand.nextGaussian() * 0.08499999832361937D * (double)var1;
    }
    ...
    public void setBuck(boolean var1)
    {
        this.isBuck = var1;
    }
    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            if (this.ticksInAir == 2 && this.isBuck)
            {
                this.setDamage(0.0D);
                this.setDead();
            }
            ...
            if (var4 != null)
            {
                if (var4.entityHit != null)
                {
                    ...
                    if (var4.entityHit.attackEntityFrom(var23, var22))
                    {
                        ...
                        this.playSound("resources.newsound.gunshot", 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
    ...
    public void onCollideWithPlayer(EntityPlayer var1)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (var2)
            {
                this.playSound("resources.newsound.gunshot", 0.2F, ((this.rand.nextFloat() - this.rand.nextFloat()) * 0.7F + 1.0F) * 2.0F);
