...
public class ModelNightStalker extends ModelBase
{
	//fields
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity ent)
	{
		...
		this.Leg3.rotateAngleX = MathHelper.cos(f2 * 0.6662F + (float)Math.PI) * 1.4F * f3;
		this.Leg4.rotateAngleX = MathHelper.cos(f2 * 0.6662F) * 1.4F * f3;
	}
