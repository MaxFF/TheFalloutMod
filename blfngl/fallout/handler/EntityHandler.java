...
public class EntityHandler
{
	public static void init()
	{
		...
		EntityRegistry.addSpawn(EntityFGhoul.class, 5, 1, 2, EnumCreatureType.monster, FalloutMain.Wasteland);
		...
		EntityRegistry.addSpawn(EntityGlowingOne.class, 5, 1, 2, EnumCreatureType.creature, FalloutMain.Wasteland);
		...
		EntityRegistry.addSpawn(EntityNightStalker.class, 5, 1, 2, EnumCreatureType.creature, FalloutMain.Wasteland);
		...
		EntityRegistry.addSpawn(EntityBrahmin.class, 5, 1, 2, EnumCreatureType.creature, FalloutMain.Wasteland);
		...
		EntityRegistry.addSpawn(EntityGiantAnt.class, 5, 1, 2, EnumCreatureType.creature, FalloutMain.Wasteland);
		...
		EntityRegistry.addSpawn(EntityBOSPaladin.class, 5, 1, 2, EnumCreatureType.creature, FalloutMain.Wasteland);
