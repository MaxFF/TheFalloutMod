...
public class GunGauge12 extends ItemSword
{
	private int damage;
	...
	public ItemStack onItemRightClick(ItemStack var1, World var2, EntityPlayer var3)
	{
		...
		else if (!var2.isRemote && var3.inventory.hasItem(FalloutMain.aGauge12.itemID) && var1.getItemDamage() == this.ammo)
		{
			if (this.reloadTime == this.reloadTotal)
			{
				this.reloadTime = 0;
				var2.playSoundAtEntity(var3, this.reloadsound, 1.0F, 1.0F);
				var3.inventory.consumeInventoryItem(FalloutMain.aGauge12.itemID);
				count += 1;
	...
	public void addInformation(ItemStack var1, EntityPlayer var2, List var3, boolean var4)
	{
		...
		var3.add("Ammo type: 12 Gauge Shotgun Shells");
	}
}
