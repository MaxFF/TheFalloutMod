...
public class DimensionWastelandWorldHandler extends WorldProvider
{
	private float[] colorsSunriseSunset = new float[4];

	public void registerWorldChunkManager()
	{
		worldChunkMgr = new WorldChunkManagerHell(Fallout.Wasteland, this.dimensionId, this.dimensionId);
		dimensionId = Fallout.dimensionWasteland;
		hasNoSky = false;
	}

	public IChunkProvider createChunkGenerator()
	{
		return new DimensionWastelandChunkHandler(this.worldObj, this.worldObj.getSeed(), false);
	}
	...
	{
		if ((this instanceof DimensionWastelandWorldHandler))
		{
			return "Entering Alien Dimension";
		}
		return null;
	}
